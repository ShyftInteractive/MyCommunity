...
class RoleCollection extends Collection
{
    ...
    public function isExecutiveOrAccount()
    {
        return $this->contains(function($role) {
            return $role->type == MemberRoles::ACCOUNT_ADMIN() || $role->type == MemberRoles::ACCOUNT_OWNER() || $role->type == MemberRoles::WORKSPACE_OWNER();
        });
    }

    public function isWorkspaceOwner()
    {
        return $this->contains('type', MemberRoles::WORKSPACE_OWNER());
    }
